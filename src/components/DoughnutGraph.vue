...
<template>
  ...
  <div class="relative">
    <div class="card flex justify-center">
      <Chart type="doughnut" :data="chartData" :options="chartOptions" class="w-full h-[300px]" :aria-label="`Doughnut Graph showing remaining feed today, where there has been used 156.2kg out of the maximum of ${maxFeedKg}`"/>
